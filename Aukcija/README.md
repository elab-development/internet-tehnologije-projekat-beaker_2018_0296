...
The frontend starter also provides an example of interactions with your AukcijaClient in [`AppCalls.tsx`](frontend/src/components/AppCalls.tsx) component by default.
